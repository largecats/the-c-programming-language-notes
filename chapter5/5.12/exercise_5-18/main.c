...
/*
$ gcc chapter5/5.12/exercise_5-18/main.c chapter5/5.12/exercise_5-18/gettoken.c helper_functions.c -o chapter5/5.12/exercise_5-18/result.out

$ chapter5/5.12/exercise_5-18/result.out
token =
tokentype = 0
int (*)[13]
token = int
